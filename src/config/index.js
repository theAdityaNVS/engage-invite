...
export const ENGAGEMENT = {
  ...
  VENUE_NAME:       'Suryansh Hotel',
  VENUE_CITY:       'Bhubaneswar',
  VENUE_ADDRESS:    'Suryansh Hotel, Bhubaneswar, Odisha',
  VENUE_LAT:        20.2961,
  VENUE_LNG:        85.8245,
  ...
  EVENTS: [
    {
      ...
      day:          'Wednesday',
      time:         '10:00 AM',
      venue:        'Suryansh Hotel, Bhubaneswar',
      address:      'Suryansh Hotel, Bhubaneswar, Odisha',
      lat:          20.2961,
      lng:          85.8245,
      mapsUrl:      'https://maps.google.com/?q=Suryansh+Hotel+Bhubaneswar',
      illustration: 'puja',
    },
    {
      id:           'ring-ceremony',
